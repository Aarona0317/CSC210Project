...
public class Login extends Application {
    ...
    public void start(Stage primaryStage) {
        // Initialize the ClothingStore object
        c = new ClothingStore();
    ...
    private void handleCalculateCost() {
        ...
        if (itemName.isEmpty() || quantityText.isEmpty()) {
            PreCostLabel.setText("Please enter item or quantity.");
            TaxLabel.setText("");
        ...
        if (quantity < 0) {
            PreCostLabel.setText("Negative numbers are not allowed.");
            TaxLabel.setText("");
            TotalCostLabel.setText("");
            return;
        }
